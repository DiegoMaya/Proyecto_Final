...
//  Texto 
union{
    text { ttf "crystal.ttf", "en ...", 1, 0
        translate <-5, 4, -11>
        scale <2, 2, 1>
        rotate <-2, 1, -1>
        }    
    text { ttf "crystal.ttf", "Geometria", 1, 0
        translate <1, 3, -11>
        scale <2.2, 2, 1>
        rotate <-2, -5, 0>
        }
    text { ttf "crystal.ttf", "Solida", 1, 0
        translate <1, 2, -11>
        scale <2.2, 2, 1>
        rotate <-2, -5, 0>
        }
     text { ttf "crystal.ttf", "Constructiva", 1, 0
        translate <1, 1, -11>
        scale <2.2, 2, 1>
        rotate <-2, -3, 0>
        }
